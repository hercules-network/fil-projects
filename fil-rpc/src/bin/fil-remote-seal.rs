...
fn main(){
    ...
    server_builder.add_service(fil_rpc::service_grpc::FilRemoteSealServer::new_service_def(fil_rpc::impl_remote_seal::ImplFilRemoteSeal));
